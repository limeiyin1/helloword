...
<script type="text/javascript">
	...
	var appleAccept = function(callback) {
		var ids = getGridIds();
		if (!ids) {
			return false;
		}
		ajaxPost("appleAccept", {ids : ids}, callback);
	}
</script>
</head>
<body>
	<!-- 综合查询条件的表格  -->
	   <div id="module_container" >
		...
		<div id="module_toolbar" class="easyui-toolbar">
	        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-heart-rf" plain="true" onclick="appleAccept(callback)">受理</a>
