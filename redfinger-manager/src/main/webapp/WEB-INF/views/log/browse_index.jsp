...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'浏览源',field:'browseFrom',sortable:true},
			{width:100,title:'应用Id',field:'apkId',sortable:true},
			{width:100,title:'应用名',field:'apkName',sortable:true},
			{width:100,title:'应用版本',field:'apkVersion',sortable:true},
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">
				应用名：<input type="text" class="easyui-textbox input_width_default" id="apkName" name="apkName"/>
			</div>
			<div class="module_search_input">
