...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'应用id',field:'apkId',sortable:true},
			{width:200,title:'应用名称',field:'apkName',sortable:true,},
			{width:200,title:'应用版本',field:'apkVersion',sortable:true},
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">
				应用名称：<input type="text" class="easyui-textbox input_width_default" id="apkName" name="apkName"/>
				应用版本：<input type="text" class="easyui-textbox input_width_default" id="apkVersion" name="apkVersion"/>
			</div>
			<div class="module_search_input">
