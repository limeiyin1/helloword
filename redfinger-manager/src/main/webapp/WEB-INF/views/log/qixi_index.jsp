...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			{width:90,title:'邀请人',field:'inviterPhone'},
			{width:90,title:'邀请人设备过期时间',field:'inviterExpireTime',formatter:formatterTime},
			{width:90,title:'被邀请人',field:'inviteePhone'},
			{width:90,title:'被邀请人绑定设备时长',field:'map.timeStr'},
			{width:90,title:'被邀请人设备过期时间',field:'inviteeExpireTime',formatter:formatterTime},
			{width:90,title:'领取时间',field:'bindPadTime',formatter:formatterTime},
			{width:90,title:'设备编码',field:'padCode'},
			{width:90,title:'被邀请人注册时间',field:'signTime',formatter:formatterTime},
		]]
	};
	var dialogParamObj={
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">
			   邀请人：<input type="text" name="inviterPhone" class="easyui-textbox input_width_default" />
			</div>
			<div class="module_search_input">
			...
			<div class="module_search_input">
		     ...
		     <div class="module_search_input">		
				是否领取到设备:<select class="easyui-combobox input_width_short" editable="false" name="padBindStatus" data-options="required:false">
