...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'游戏名称',field:'map.apkName'},
			{width:150,title:'评论时间',field:'createTime',sortable:true,formatter:formatterTime},
			{width:100,title:'内容',field:'content',sortable:true},
			{width:100,title:'分数',field:'score',sortable:true},
			{width:100,title:'审核状态',field:'verifyStatus',sortable:true},
			{width:100,title:'审核时间',field:'verifyTime',sortable:true,formatter:formatterTime},
			{width:100,title:'审核管理员',field:'verifyPerson',sortable:true},
			{width:100,title:'点赞数',field:'countGood',sortable:true},
			{width:100,title:'点赞虚假次数',field:'countGoodBase',sortable:true},
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">
				游戏名：<input type="text" class="easyui-textbox input_width_default" id="apkname" name="apkname"/>
