...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'被邀请用户',field:'map.inviteeMobilePhone',sortable:true},
			...
			{width:150,title:'邀请码到期时间',field:'map.taskEndTime',sortable:true,formatter:formatterTime},
			{width:100,title:'邀请人',field:'map.userMobilePhone',sortable:true},
			{width:100,title:'邀请状态',field:'taskRecordStatus',sortable:true,formatter:function(val, row) {if(val=='1'){
