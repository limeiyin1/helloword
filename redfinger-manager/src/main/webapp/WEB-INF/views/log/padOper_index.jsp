...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'操作类别',field:'category',sortable:true,formatter:function(value){return getDatagridDict('log_pad.category',value);}},
			{width:100,title:'管理员',field:'creater',sortable:true},
			{width:200,title:'设备编码',field:'padCode',sortable:true},
			{width:200,title:'操作IP',field:'operIp',sortable:true}
		]]
	};
	var dialogParamObj={
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">
				...
				<select class="easyui-combobox input_width_default" editable="false" name="category">
					...
					<fns:getOptions category="log_pad.category"/>
				</select>
			</div>
			<div class="module_search_input">
				操作人：<input type="text" class="easyui-textbox input_width_default" name="creater" data-options=""/>
			</div>
			<div class="module_search_input">
