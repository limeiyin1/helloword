...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'考核项目',field:'name',sortable:true},
			{width:100,title:'分数',field:'point',sortable:true},
			{width:100,title:'关键字',field:'keyword',sortable:true},
...
<body>
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			...
			<div class="module_search_input">关键字：<input type="text" name="keyword" class="easyui-textbox input_width_default"/></div>
