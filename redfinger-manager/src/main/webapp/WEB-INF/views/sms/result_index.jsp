...
<script type="text/javascript">
	...
	var dataGridParamObj={
		url:host+"list",
		idField : 'resultInfoId',
		onCheck: function(row){
			
		},
		columns:[[
			{width:100,title:'id',field:'resultInfoId',checkbox:true},
			{width:100,title:'编码',field:'resultCode',sortable:true},
			{width:600,title:'编码描述',field:'resultCodeDetail'},
			{width:60,title:'发送方',field:'smsResultType',formatter:function(value){return getDatagridDict('sms.sms_send_type',value)}},
			{width:100,title:'描述',field:'remark'},
			{width:40,title:'排序',field:'reorder',sortable:true},
			{width:60,title:'状态',field:'enableStatus',sortable:true,formatter:formatterStop}
		]]
	};
	var dialogParamObj={
...
<body>
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">编码：<input type="text" name="resultCode" class="easyui-textbox input_width_default"/></div>
			<div class="module_search_input">编码描述：<input type="text" name="resultCodeDetail" class="easyui-textbox input_width_default"/></div>
			<div class="module_search_input">发送方类型：
