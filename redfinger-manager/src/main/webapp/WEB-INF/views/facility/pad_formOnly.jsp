  ...
  <input type="hidden" name="padId" value="${bean.padId}">
	<table id="module_submit_table">
		<tr>
			...
			<td class="td2"><input class="easyui-textbox" type="text" name="padCode" value="${bean.padCode }" data-options="required:true,validType:'length[0,32]'" /></td>
		</tr>
		<tr>
			<td class="td1">设备IP:</td>
			<td class="td2">
			<input style="width:255px" class="easyui-textbox" type="text" name="padIp" value="${bean.padIp}" data-options="required:true,validType:['checkIp']" missingMessage="必须填写正确的IP格式" />
		...
		<tr>
			...
			<td class="td2">	<input class="easyui-textbox" type="text" name="padName" value="${bean.padName }" data-options="required:true,validType:'length[0,66]'" /></td>
		</tr>
