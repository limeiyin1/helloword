...
<script type="text/javascript">
	...
	var dataGridParamObj = {
		...
		columns : [[ {width : 100,title : 'id', field : pk,checkbox : true},
			{width : 100,title : '用户控制节点', field : 'userControlName'},
			{width : 100,title : '设备控制节点', field : 'padControlName'},
			{width : 100,title : '设备管理控制节点', field : 'manageControlName'},
			{width : 100,title : '设备视频', field:'padVideoName'},
			{width : 100,title : '用户视频', field : 'userVideoName'},
