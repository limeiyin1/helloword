...
<body>
	<script type="text/javascript">
		...
		function countPadCodes(message,codes) {
			var codelist;
		...
		<tr>
	     ...
	     <tr>
			...
			<td class="td2"><fieldset>
						<legend>请输入内容</legend>
						<textarea name="padCode" wrap=PHYSICAL style="width: 220px;height: 200px" onKeyDown="countPadCodes(this.form.padCode,this.form.phons);"
						onKeyUp="countPadCodes(this.form.padCode,this.form.phons);"></textarea>
		                </fieldset>
		    </td>
		 </tr>
		 <tr>
