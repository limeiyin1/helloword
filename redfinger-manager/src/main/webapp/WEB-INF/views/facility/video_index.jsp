		...
		<div id="module_search">
			<form id="module_search_form" class="easyui-form" method="post">
				<div class="module_search_input">
					名称：<input type="text" name="videoName"
						class="easyui-textbox input_width_default" />
				</div>
				<div class="module_search_input">		
					视频类型:<select class="easyui-combobox input_width_short"  editable="false" name="videoType" data-options="required:false">
							<option value="">[全部]</option>
						   <fns:getOptions category="rf_video.video_type"  ></fns:getOptions>
							</select> 
				 </div>	
