...
<script type="text/javascript">
	...
	var dataGridParamObj = {
		...
		columns : [[ {width : 100,title : 'id', field : pk,checkbox : true},
			{width : 100,title : '设备池编码', field : 'facilityCode'},
			{width : 100,title : '设备来源', field : 'facilityName'},
			{width : 100,title : '总设备数', field : 'map.allCount'},
		...
		<div id="module_search">
			<form id="module_search_form" class="easyui-form" method="post">
				<div class="module_search_input">
					设备来源：
					<input type="text" name="facilityName" class="easyui-textbox input_width_default" /> 
				</div>
