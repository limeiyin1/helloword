...
<body>
	...
	<input type="hidden" name="faultFeedbackId" value="${bean.faultFeedbackId}"/>
		...
		<tr>
			...
			<td class="td2">
				<select class="easyui-combobox"  editable="false" data-options="required:true" name="feedbackSource">
					<fns:getOptions category="rf_fault_feedback.feedback_source" value="${bean.feedbackSource }"></fns:getOptions>
				</select>
			</td>
		</tr>
		<tr>
