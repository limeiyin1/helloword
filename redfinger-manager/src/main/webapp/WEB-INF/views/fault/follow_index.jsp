...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
					...
					{width:100,title:'修复时间',field:'modifyTime',sortable:true,formatter:formatterTime},
	...
	function reply(){
		...
		ajaxPost("reply", {ids : ids}, callback);
	}
	//双击callback
...
<body>
	...
	<div id="module_container" >
		...
		<div id="module_toolbar" class="easyui-toolbar">
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok-rf" plain="true" onclick="reply()">处理完毕确认</a>
