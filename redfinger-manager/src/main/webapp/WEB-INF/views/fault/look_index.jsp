	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			...
			<div class="module_search_input">故障类型：
				<input type="text" value="0" name="classId" class="easyui-combotree input_width_long3" data-options='data:${categoryTree}' />
			</div>
			<div class="module_search_input">修复类型：
				<input type="text" value="0" name="smallClassId" class="easyui-combotree input_width_long" data-options='data:${categoryFixTree}' />
			</div>
			<div class="module_search_input">故障状态：
				<select class="easyui-combobox input_width_default" editable="false" name="feedbackStatus">
					...
					<fns:getOptions category="rf_fault_feedback.feedback_status"/>
				</select>
			</div>
		...
		<div id="module_toolbar" class="easyui-toolbar">
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-excel-rf',plain:true" id="export-link">导出</a>
