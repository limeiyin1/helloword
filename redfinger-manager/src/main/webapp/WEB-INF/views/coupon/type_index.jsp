...
<script type="text/javascript">
	...
	var dataGridParamObj = {
		...
		columns : [[
			...
			{width : 100,title : '优惠劵类型名称',field : 'typeName',sortable : true},  
			{width : 100,title : '优惠劵类型编码',field : 'typeCode',sortable : true}, 
	...
	function batchEditModule(){
		...
		$(module_dialog).dialog({title : title,href: href,width:800, left:screen.width/7});
		$(module_dialog).dialog("open");
	}
		...
		<div id="module_search">
			<form id="module_search_form" class="easyui-form" method="post">
				<div class="module_search_input">
					优惠劵类型名称：<input type="text" name="typeName"
