...
<body>
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			...
			<div class="module_search_input">
				统计时段：
				<input type="text" class="easyui-datebox input_width_default" id="begin" name="begin" editable="false" data-options="onSelect:beginSelect"/>
				至
				<input type="text" class="easyui-datebox input_width_default" id="end" name="end" editable="false" data-options="onSelect:endSelect"/>
			</div>
