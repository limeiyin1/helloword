...
function statSearch(){
	...
	$.messager.progress();
	$.getJSON(host+'getChart',{type:type,end:end,begin:begin},function(data){
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			...
			<div class="module_search_button">
		        ...
		        <a href="javascript:void(0)" id="floatExpire" >&nbsp;&nbsp;&nbsp;总用户数 :</a>	
			</div>
		</form>
		</div>
