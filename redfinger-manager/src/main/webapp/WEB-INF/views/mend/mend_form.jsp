...
<body>
	...
	<table id="module_submit_table">
		<tr>
			...
			<td class="td2"><input type="hidden" name="mendChannelCode" value="${bean.mendChannelCode }" />${bean.mendChannelCode }</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="td2">
				<input type="hidden" name="mendOsType" value="mend" />${bean.mendOsType }
		...
		<tr>
			...
			<td class="td2">
			<textarea rows="13" cols="38" maxlength="500" name="mendVersionDesc">${bean.mendVersionDesc}</textarea>
			</td>
