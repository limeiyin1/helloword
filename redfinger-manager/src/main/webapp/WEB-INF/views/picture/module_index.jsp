...
<script type="text/javascript">
	...
	var dataGridParamObj = {
		...
		columns : [[
			...
			{width : 100,title : '模块编码',field : 'moduleCode',sortable : true}, 
			{width : 100,title : '模块名称',field : 'moduleName',sortable : true},
...
<body>
	...
	<div id="module_container">
		<div id="module_search">
			<form id="module_search_form" class="easyui-form" method="post">
				<div class="module_search_input">
					模块编码：<input type="text" name="moduleCode"
		...
		<div id="module_toolbar" class="easyui-toolbar">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				...
				iconCls="icon-edit-rf" plain="true" onclick="editModule()">编辑</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"
	...
	<!-- 图片编辑框 -->
	<div id="module_picture_dialog" buttons="#module_picture_dialog_button" ></div>
	<div id="module_picture_dialog_button" >
