...
<script type="text/javascript">
	...
	var dataGridParamObj = {
		...
		columns : [[ 
		              {width : 100,title : 'id',field : 'labelId',checkbox : true}, 
		              {width : 100,title : '标签编码',field : 'labelCode',sortable : true}, 
		              {width : 100,title : '标签名称',field : 'labelName',sortable : true}, 
		              {width : 50,title : '标签类型',field:'labelType',sortable:true,formatter:formatterLabelType},
		...
		<div id="module_search">
			<form id="module_search_form" class="easyui-form" method="post">
				<div class="module_search_input">
					标签名称：<input type="text" name="labelName"
						class="easyui-textbox input_width_default" /> 
				</div>
				<div class="module_search_input">		
					标签类型:<select class="easyui-combobox input_width_short"  editable="false" name="labelType" data-options="required:false" >
						<option value="">[全部]</option>
					   	<fns:getOptions category="rf_label.label_type"  ></fns:getOptions>
						</select> 
				 </div>	
