...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'应用名称',field:'gameGroupName',sortable:true},
			{width:100,title:'应用类型',field:'softType',sortable:true,formatter:function(value){return getDatagridDict('rf_game.soft_type',value);}},
...
<body>
	...
	<div id="module_container">
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">应用名称：<input type="text" name="gameGroupName" class="easyui-textbox input_width_default"/></div>
