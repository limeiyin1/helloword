...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'游戏名称',field:'map.gameAppName',sortable:false},
			...
			{width:100,title:'试玩游戏应用图片',field:'gameAppImage',sortable:false},
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
		    <div class="module_search_input">
		              游戏应用：<select class="easyui-combobox"  editable="false" name="gameAppId" data-options="required:false" >
