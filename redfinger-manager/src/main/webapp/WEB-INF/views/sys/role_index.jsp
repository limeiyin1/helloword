...
function permission(){
	var id=getGridId();
	if(!id)return false;
	var title=$("title").html()+" - 赋予权限";
	var href=host+'permissionForm?roleCode='+id;
	$("#button-save").unbind("click").click(permissionSave);
	...
	<div id="module_container">
		...
		<div id="module_toolbar" class="easyui-toolbar">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				...
				href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-star-rf" plain="true" onclick="permission()">赋予权限</a>
			<a href="javascript:void(0)" class="easyui-linkbutton"
