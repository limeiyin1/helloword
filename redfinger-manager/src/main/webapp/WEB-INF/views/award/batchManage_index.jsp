...
<script type="text/javascript">
	...
	var dataGridParamObj = {
		...
		columns : [ [ {
			...
			width : 100,
			title : '优惠劵类型',
			field : 'map.couponName',
			sortable : true
		}, {
			width : 100,
			title : '激活码类型',
			field : 'map.activationTypeName',
			sortable : true
		},{
			width : 100,
			title : '创建人',
	...
	<div id="module_container">
		<div id="module_search">
			<form id="module_search_form" class="easyui-form" method="post">
				...
				<div class="module_search_input">
					奖品类型：<select class="easyui-combobox input_width_short"
						editable="false" name="awardCategory"
						data-options="required:false">
						<option value="">[全部]</option>
						<fns:getOptions category="rf_award_batch.award_category"></fns:getOptions>
					</select>

				</div>
				<div class="module_search_input">
					奖品名称：<input type="text" name="awardName"
