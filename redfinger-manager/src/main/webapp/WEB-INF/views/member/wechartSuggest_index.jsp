...
<script type="text/javascript">
	...
	var dataGridParamObj={
		...
		columns:[[
			...
			{width:100,title:'微信昵称',field:'nickname',sortable:true},
			{width:150,title:'微信openId',field:'openid',sortable:true},
			{width:400,title:'意见内容',field:'suggestContent',sortable:true},
			{width:150,title:'创建时间',field:'createTime',sortable:true,formatter:formatterTime},
			{width:50,title:'启用状态',field:'enableStatus',sortable:true,formatter:formatterStop},
			{width:50,title:'状态',field:'status',sortable:true,formatter:formatterStop},
			{width:50,title:'是否处理',field:'dealWith',sortable:true},
			{width:50,title:'是否采纳',field:'isAdoption',sortable:true},
	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">
				微信昵称：<input type="text" class="easyui-textbox input_width_default" id="nickname" name="nickname"/>
				微信openId：<input type="text" class="easyui-textbox input_width_default" id="openid" name="openid"/>
				意见内容：<input type="text" class="easyui-textbox input_width_default" id="suggestContent" name="suggestContent"/>
			</div>
