	...
	<div id="module_container" >
		...
		<form id="module_search_form" class="easyui-form" method="post">
			<div class="module_search_input">
				开始IP段：
				<input type="easyui-numberbox" name="startIp" id="startIp" class="easyui-textbox input_width_default"/>
			</div>
			<div class="module_search_input">
				结束IP段：
				<input type="easyui-numberbox" name="endIp" id="endIp" class="easyui-textbox input_width_default"/>
			</div>
