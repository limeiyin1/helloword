...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	 ...
	 * @return
	 */
	public static <T> String joiner(List<T> list, String fieldName,boolean cutLast) {
		StringBuffer sb = new StringBuffer("");
		if (!CollectionUtils.isEmpty(list)) {
			for (T t : list) {
				Object obj = Reflections.invokeGetter(t, fieldName);
	...
	public static String getEnv(){
		return SpringContextHolder.getBean(DataInitProcessor.class).getEnv();
	}
