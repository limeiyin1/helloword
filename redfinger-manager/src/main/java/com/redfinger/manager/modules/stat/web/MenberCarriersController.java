...
import com.redfinger.manager.modules.stat.service.StatMemberService;

@Controller
@RequestMapping(value = "/stat/menberCarriers")
public class MenberCarriersController extends BaseController {


	@Autowired
	StatMemberService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statMemberMobileCarriers();
	}
