...
import com.redfinger.manager.modules.stat.service.StatGameDownLoadService;


@Controller
@RequestMapping(value = "/stat/gameDownload")
public class GameDownloadController extends BaseController{
	
	@Autowired
	StatGameDownLoadService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statGameDown(bean);
	}
