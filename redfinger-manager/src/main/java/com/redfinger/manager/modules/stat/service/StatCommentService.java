...
import com.redfinger.manager.common.mapper.StatCommentMapper;
...
public class StatCommentService extends
		BaseService<AppComment, StatCommentMapper, AppCommentExample> {
	@Autowired
	StatCommentMapper mapper;

	@Transactional(readOnly = true)
	public Map<String, Object> stat(StatDomain bean) {
		this.validate(bean);
		List<StatDomain> list = mapper.statComment(bean);
		int countAll = 0;// 总数统计
