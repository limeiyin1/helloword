...
import com.redfinger.manager.modules.stat.service.StatKeywordService;


@Controller
@RequestMapping(value = "/stat/keyword")
public class StatKeywordController extends BaseController {


	@Autowired
	StatKeywordService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statKeywordConut(bean);
	}
