...
import com.redfinger.manager.modules.stat.service.StatCommentService;


@Controller
@RequestMapping(value="/stat/comment")
public class StatCommentController extends BaseController{

		@Autowired
		StatCommentService service;
