...
import com.redfinger.manager.modules.stat.service.StatActiveUserService;

@Controller
@RequestMapping(value="/stat/activeuser")
public class StatActiveUserController extends BaseController{

	@Autowired
	StatActiveUserService service;
