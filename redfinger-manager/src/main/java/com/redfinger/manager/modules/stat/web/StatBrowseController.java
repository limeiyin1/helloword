...
import com.redfinger.manager.modules.stat.service.StatBrowseService;



@Controller
@RequestMapping(value="/stat/browse")
public class StatBrowseController extends BaseController {
	
	@Autowired
	StatBrowseService service;
	...
	public String export(HttpServletRequest request, HttpServletResponse response, Model model,
			String exportDatas, String exportHead, String exportField, String exportName) throws Exception {
		...
		List<String> lableList = (List<String>) map.get("lable");
