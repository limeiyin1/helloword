...
@Controller
@RequestMapping(value = "/stat/faultYunweiFixTime")
public class FaultYunweiFixTimeController extends BaseController {
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		bean.setWhere(ConfigConstantsDb.configRoleYunwei());
		return service.statFualtFixTimeByRole(bean);
	}
