...
import com.redfinger.manager.modules.stat.service.StatFaultFeedbackService;

@Controller
@RequestMapping(value = "/stat/faultCategoryFix")
public class FaultCategoryFixController extends BaseController {


	@Autowired
	StatFaultFeedbackService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statFaultCategoryFix(bean);
	}
