...
import com.redfinger.manager.modules.stat.service.StatBleedUserService;

@Controller
@RequestMapping(value="/stat/bleeduser")
public class StatBleedUserController extends BaseController{
	
	@Autowired
	StatBleedUserService service;
