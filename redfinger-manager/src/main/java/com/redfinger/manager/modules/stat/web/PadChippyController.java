...
import com.redfinger.manager.modules.stat.service.PadChippyService;
@Controller
@RequestMapping(value = "/stat/padChippy")
public class PadChippyController extends BaseController {

	@Autowired
	PadChippyService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		bean.setWhere("category in ('add')");
		return service.statChippyPad2Time(bean);
	}
