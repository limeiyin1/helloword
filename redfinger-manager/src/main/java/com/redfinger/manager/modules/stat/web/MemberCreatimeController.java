...
import com.redfinger.manager.modules.stat.service.StatMemberCreatimeService;

@Controller
@RequestMapping(value = "/stat/memberCreatime")
public class MemberCreatimeController extends BaseController {


	@Autowired
	StatMemberCreatimeService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statMemberCreatime(bean);
	}
