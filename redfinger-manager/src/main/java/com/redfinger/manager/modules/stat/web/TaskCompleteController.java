...
import com.redfinger.manager.modules.stat.service.StatTaskCompleteService;
import com.redfinger.manager.modules.tasks.service.RbcTaskService;

@Controller
@RequestMapping(value = "/stat/taskOk")
public class TaskCompleteController extends BaseController {


	@Autowired
	StatTaskCompleteService service;
	@Autowired
	RbcTaskService rbcTaskService;
	
	@RequestMapping(value = "")
	public String index(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		  /*List<RfRbcTask>taskList=rbcTaskService.initQuery().findStopTrue();
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statTaskComplete2Time(bean);
	}
