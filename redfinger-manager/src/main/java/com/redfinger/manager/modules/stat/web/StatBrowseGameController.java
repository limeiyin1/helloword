...
import com.redfinger.manager.modules.stat.service.StatBrowseGameService;

@Controller
@RequestMapping(value = "/stat/game")
public class StatBrowseGameController extends BaseController {
	@Autowired
	StatBrowseGameService service;
