...
import com.redfinger.manager.modules.stat.service.StatLogSearchCountService;


@Controller
@RequestMapping(value = "/stat/logSearchCount")
public class LogSearchCountController extends BaseController {


	@Autowired
	StatLogSearchCountService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statAppLogSearchConut(bean);
	}
