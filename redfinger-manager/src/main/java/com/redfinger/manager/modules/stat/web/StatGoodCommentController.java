...
import com.redfinger.manager.modules.stat.service.StatGoodCommentService;

@Controller
@RequestMapping(value="/stat/apkcomment ")




public class StatGoodCommentController extends BaseController{
	@Autowired
	StatGoodCommentService service;
