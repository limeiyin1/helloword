...
import com.redfinger.manager.modules.stat.service.StatLoginOneService;

@Controller
@RequestMapping(value="/stat/loginone")
public class StatLoginOneController extends BaseController{
	@Autowired
	StatLoginOneService service;
