...
import com.redfinger.manager.modules.stat.service.StatTaskSendRbcService;


@Controller
@RequestMapping(value = "/stat/taskRbcSend")
public class TaskSendRbcController extends BaseController {


	@Autowired
	StatTaskSendRbcService service;
	...
	public Map<String,Object> getChart (HttpServletRequest request, HttpServletResponse response, Model model,StatDomain bean) {
		return service.statTaskSendRbc2Time(bean);
	}
