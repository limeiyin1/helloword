...
/**
 * 
* @ClassName: TaskAttendanceTest
* @Description: 签到任务
* @author tluo
* @date 2015年11月6日 上午10:36:46
*
 */
public class TaskAttendanceTest {
	...
	public void screenTest() {
		...
		//调用
		Map<String, Object> map = template.postForObject(host + "task/attendance.html?userId={userId}&sessionId={sessionId}&taskId={taskId}", null, Map.class,prams);
		//打印返回值
